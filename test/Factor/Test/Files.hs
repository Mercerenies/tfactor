...
--           testFile p "std/test/usertypes_2.txt.bak",
--           testFile p "std/test/usertypes_3.txt.bak",
--           testFile p "std/test/usertypes_4.txt.bak",
--           testFile p "std/test/usertypes_5.txt.bak",
